...
class TasksListCreate(Resource):
    ...
    def get(self):
        ...
        if not tasks:
            return {"message": "Tasks data is not found", "statusCode": 404}, 404
    ...
    def post(self):
        ...
        if not content:
            return {
                "message": "Bad request. Please enter valid data",
                "statusCode": 400,
            }, 400
        ...
        if not content.get("title", ""):
            return {
                "message": "Bad request. Please enter title for task",
                "statusCode": 400,
            }, 400
        ...
        if not result.inserted_id:
            return {"message": "Failed to insert", "statusCode": 500}, 500
...
class TasksRetrieveUpdateDelete(Resource):
    ...
    def get(self, _id):
        ...
        if not task:
            return {"message": "Task data is not found", "statusCode": 404}, 404
    ...
    def put(self, _id):
        ...
        if content and query:
            ...
            if not result.modified_count:
                return {"message": "No changes applied", "statusCode": 500}, 500
        else:
            return {
    ...
    def delete(self, _id):
        ...
        if not result.deleted_count:
            return {"message": "Task data is not found!", "statusCode": 500}, 500
...
class Register(Resource):
    ...
    def post(self):
        ...
        if not email:
            return {
                "message": "Bad request. Please Enter email address",
                "statusCode": 400,
            }, 400

        if not checkEmailValidation(email):
            return {
                "message": "Bad request. Please Enter valid email",
                "statusCode": 400,
            }, 400

        if not password:
            return {
                "message": "Bad request. Please Enter password",
                "statusCode": 400,
            }, 400

        if not len(password) >= 8:
            return {
                "message": "Bad request. Enter password with 8 character",
                "statusCode": 400,
            }, 400
...
class Login(Resource):
    ...
    def post(self):
        ...
        return {"message": "Logged in Successfully", "statusCode": 200}, 200
